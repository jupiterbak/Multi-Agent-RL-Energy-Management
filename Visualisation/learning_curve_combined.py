...
if __name__ == '__main__':
    ...
    for scenario in range(SCENARIO_COUNT):
        ...
        plot_all_learning_curve(axes[0, scenario], train_sizes=train_sizes, train_scores=train_scores,
                                title="Scenario {}".format(scenario), alpha=0.2)
        ...
        plot_agents_learning_curve(axes[1, scenario], agent_train_data_sizes=a_data_sizes,
                                   agent_train_data_scores=a_data_scores, titles=AGENT_NAMES[scenario], alpha=0.2)
        ...
        # Production
        plot_plant_performance(axes[2, scenario], production__sizes=production_sizes,
                               production_performance=production_performances,
                               _power_consumtions=power_consumptions,
                               alpha=0.5)
        # Energy Costs
        plot_energy_costs(axes[3, scenario], train_sizes=energy_prices_sizes, energy_prices=energy_prices,
