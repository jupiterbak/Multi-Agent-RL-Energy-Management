...
class EFlexMultiAgentCooperationClsV3(gym.Env):
    ...
    def _import_module(module_name, class_name):
        ...
        module = getattr(module0, 'EFlexMultiAgentCooperationV3')
    ...
    def step(self, action):
        ...
        for i, agent in enumerate(self.agents):
            ...
            if hasattr(agent, 'production_count'):
                if agent.current_state.value == EFLEXAgentState.Completed.value \
                        and last_agent_state == EFLEXAgentState.Execute.value:
